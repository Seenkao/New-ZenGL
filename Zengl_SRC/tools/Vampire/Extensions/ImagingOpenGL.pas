...
{ This unit contains functions for loading and saving OpenGL textures
  ...
  (* Этот блок содержит функции для загрузки и сохранения текстур OpenGL с использованием
    Imaging и для преобразования изображений в текстуры и наоборот *)
unit ImagingOpenGL;

{$I ImagingOptions.inc}

{ Define this symbol if you want to use dglOpenGL header.}
(* Определите этот символ, если вы хотите использовать заголовок dglOpenGL *)
