...
begin
  ...
  if time > 255 Then
    begin
      ...
      for i := 0 to 9 do
        if i = 2 Then
          begin
            ...
            pr2d_Rect( tux[ i ].Pos.X - 2, tux[ i ].Pos.Y - ScaleF + 4, t, ScaleF, newColor, PR2D_FILL );
            pr2d_Rect( tux[ i ].Pos.X - 2, tux[ i ].Pos.Y - ScaleF + 3, t, ScaleF + 1, cl_White);
            ...
            if i = 7 Then
              begin
                ...
                pr2d_Rect( tux[ i ].Pos.X + 32 - t / 2, tux[ i ].Pos.Y - ScaleF + 3, t, ScaleF + 1, cl_White);
                text_DrawEx( fntMain, tux[ i ].Pos.X + 32, tux[ i ].Pos.Y - ScaleF + 4, 1, 0, '???', cl_White, TEXT_HALIGN_CENTER );
      ...
      for i := 10 to 19 do
        if i = 13 Then
          begin
            ...
            pr2d_Rect( tux[ i ].Pos.X - 2, tux[ i ].Pos.Y - ScaleF - 10, t, ScaleF + 1, cl_White{, PR2D_SMOOTH });
      ...
      text_DrawEx( fntMain, tux[ 20 ].Pos.X + 32, tux[ 20 ].Pos.Y - ScaleF + 4, 1, 0, 'o_O', cl_White, TEXT_HALIGN_CENTER );
