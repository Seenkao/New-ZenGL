...
public class Demo06Activity extends Activity
{
	private ZenGL zengl;
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		try
		{
			appSourceDir = getPackageManager().getApplicationInfo( "zengl.demo06", 0 ).sourceDir;
		}
		...
		zengl = new ZenGL( this, "demo06", appSourceDir );
