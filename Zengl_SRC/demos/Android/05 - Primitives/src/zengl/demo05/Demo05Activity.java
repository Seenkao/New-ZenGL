...
public class Demo05Activity extends Activity
{
	private ZenGL zengl;
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		try
		{
			appSourceDir = getPackageManager().getApplicationInfo( "zengl.demo05", 0 ).sourceDir;
		}
		...
		zengl = new ZenGL( this, "demo05", appSourceDir );
