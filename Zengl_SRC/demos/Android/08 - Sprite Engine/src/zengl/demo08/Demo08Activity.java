...
public class Demo08Activity extends Activity
{
	private ZenGL zengl;
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		try
		{
			appSourceDir = getPackageManager().getApplicationInfo( "zengl.demo08", 0 ).sourceDir;
		}
		...
		zengl = new ZenGL( this, "demo08", appSourceDir );
