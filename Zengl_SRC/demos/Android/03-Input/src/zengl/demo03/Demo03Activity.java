...
public class Demo03Activity extends Activity
{
	private ZenGL zengl;
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		try
		{
			appSourceDir = getPackageManager().getApplicationInfo( "zengl.demo03", 0 ).sourceDir;
		}
		...
		zengl = new ZenGL( this, "demo03", appSourceDir );
