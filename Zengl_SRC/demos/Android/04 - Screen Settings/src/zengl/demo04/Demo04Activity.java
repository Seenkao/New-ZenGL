...
public class Demo04Activity extends Activity
{
	private ZenGL zengl;
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		try
		{
			appSourceDir = getPackageManager().getApplicationInfo( "zengl.demo04", 0 ).sourceDir;
		}
		...
		zengl = new ZenGL( this, "demo04", appSourceDir );
