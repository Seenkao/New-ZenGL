...
public class Demo09Activity extends Activity
{
	private ZenGL zengl;
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		try
		{
			appSourceDir = getPackageManager().getApplicationInfo( "zengl.demo09", 0 ).sourceDir;
		}
		...
		zengl = new ZenGL( this, "demo09", appSourceDir );
